...
// public class ToolBarSceneChangeBtn
// {
// 	
// 	public static List<CustomToolSceneChange> sceneBtnList=new List<CustomToolSceneChange>();
// }
...
public class ToolBarSceneChangeBtn
{
	public struct CustomToolSceneChangeStruct
	{
    ...
    static void OnToolbarGUI()
    {
        ...
        if (GUILayout.Button(new GUIContent("Battle", "Start Battle  Test Scene "), ToolbarStyles.commandButtonStyle))
        {
